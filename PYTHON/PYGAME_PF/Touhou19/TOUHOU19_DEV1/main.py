...
yellow_bullet_img = pygame.image.load(img_path + 'projectiles/yellow_bullet/yellow_bullet.png')
red_bullet_img = pygame.image.load(img_path + 'projectiles/red_bullet/red_bullet.png')

menu_bg_img = pygame.image.load(img_path + 'backgrounds/MAIN_MENU_BG_V2.png')
menu_bg_img = pygame.transform.scale(menu_bg_img, (1152, 864))

skies_of_gensokyo_img = pygame.image.load(img_path + 'backgrounds/skies_of_gensokyo.jpg')
skies_of_gensokyo_img = pygame.transform.scale(skies_of_gensokyo_img, (1152, 864))

awoo_img = pygame.image.load(img_path + 'backgrounds/awoo.jpg')
awoo_img = pygame.transform.scale(awoo_img, (1152, 864))

reimu_sp_2_img = pygame.image.load(img_path + 'entities/reimu/reimu_sp_2.png')
reimu_sp_2_img = pygame.transform.scale(reimu_sp_2_img, (40, 60))

nazrin_sp_1_img = pygame.image.load(img_path + 'entities/nazrin/nazrin_sp_1.png')
nazrin_sp_1_img = pygame.transform.scale(nazrin_sp_1_img, (60, 80))

button_rect_1 = pygame.image.load(img_path + 'rects/button_rect_1.png')
button_rect_1 = pygame.transform.scale(button_rect_1, (250, 70))

button_rect_2 = pygame.image.load(img_path + 'rects/button_rect_2.png')
...
def get_font_watatsuki(size): # Returns Press-Start-2P in the desired size
    return pygame.font.Font(font_path + 'WatatsukiTechSans.ttf', size)

def get_font_yuki_boku(size): # Returns Press-Start-2P in the desired size
    return pygame.font.Font(font_path + 'YujiBoku-Regular.ttf', size)
...
# dialogueItem format: 
# [nazrin_img, rect, "This is a dialogue"]
def dialogueSystem(dialogueList):
    speaking = True
    for dialogueItem in dialogueList:
        SCREEN.blit(nazrin_sp_1_img, (0,0))
        if speaking:
            draw_speech_bubble(SCREEN, "Hey", (255, 255, 0), (175, 175, 0), reimu.rect.midtop, 25)
def play():
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_0:
                    dialogueSystem(dialogueList=[nazrin_sp_1_img, nazrin_sp_1_img.get_rect, "Hello reimu"])
